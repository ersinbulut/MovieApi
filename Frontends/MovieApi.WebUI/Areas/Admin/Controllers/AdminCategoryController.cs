...
namespace MovieApi.WebUI.Areas.Admin.Controllers
{
    ...
    public class AdminCategoryController : Controller
    {
        ...
        public async Task<IActionResult> CategoryList()
        {
            ...
            var responseMessage = await client.GetAsync("https://localhost:7267/api/Categories");
        ...
        public async Task<IActionResult> CreateCategory(AdminCreateCategoryDto adminCreateCategoryDto)
        {
            ...
            var responseMessage = await client.PostAsync("https://localhost:7267/api/Categories", stringContent);
            if(responseMessage.IsSuccessStatusCode)
            {
        ...
        {
            var client= _httpClientFactory.CreateClient();
            var responseMessage = await client.DeleteAsync("https://localhost:7267/api/Categories?id=" + id);
            if (responseMessage.IsSuccessStatusCode)
            {
